  ...
  return (
    <Grid container rowSpacing={{ xs: 1, sm: 2, md: 3 }} columnSpacing={{ xs: 1, sm: 2, md: 3 }} direction={isRow ? "row" : "column"}>
      ...
      <Grid
        ...
        xs={isRow ? 12 : "auto"}
      >
        <Link className="flex flex-col items-start gap-3 self-stretch" to={`/blog/${url}`}>
          ...
          <div className="flex items-center justify-between gap-4 self-stretch">
            <h1 className={`${wrap === "nowrap" ? "text-2xl" : "text-xl"} font-semibold text-ellipsis overflow-hidden text-nowrap max-w-[280px]`}>{title}</h1>
