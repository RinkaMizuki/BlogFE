...
const Header = () => {
  ...
  return (
    <div className="inline-flex py-[30px] px-[112px] w-full">
      <div className="h-[65px] flex justify-between flex-1">
        <div className="flex justify-center items-center">
          <h1 className="font-medium text-3xl cursor-pointer">Group H</h1>
        </div>
        <div className="flex justify-center items-center gap-8 font-thin text-lg">
          <Link to="/" className={`relative ${mode === 'light' ? "after:bg-[#090D1F]" : "after:bg-[#ffffff]"} after:absolute after:content-['']  after:w-0 after:left-0 after:bottom-[-5px] after:h-1 after:block after:transition-all after:ease-in-out after:duration-200 hover:after:w-full`}>Blog</Link>
          <Link to="/projects" className={`relative ${mode === 'light' ? "after:bg-[#090D1F]" : "after:bg-[#ffffff]"} after:absolute after:content-['']  after:w-0 after:left-0 after:bottom-[-5px] after:h-1 after:block after:transition-all after:ease-in-out after:duration-200 hover:after:w-full`}>Projects</Link>
          <Link to="/about" className={`relative ${mode === 'light' ? "after:bg-[#090D1F]" : "after:bg-[#ffffff]"} after:absolute after:content-['']  after:w-0 after:left-0 after:bottom-[-5px] after:h-1 after:block after:transition-all after:ease-in-out after:duration-200 hover:after:w-full`}>About</Link>
          <Link to="/newsletter" className={`relative ${mode === 'light' ? "after:bg-[#090D1F]" : "after:bg-[#ffffff]"} after:absolute after:content-['']  after:w-0 after:left-0 after:bottom-[-5px] after:h-1 after:block after:transition-all after:ease-in-out after:duration-200 hover:after:w-full`}>Newsletter</Link>
          <Box
            className="flex px-[16px] py-[8px] rounded-[29px] gap-3"
            sx={{
          ...
          >
            <Button className="flex jsutify-center items-center max-w-[24px] h-[24px] min-w-0 rounded-[20px] cursor-pointer p-0" onClick={toggleColorMode}>
              ...
              </Box> : <svg xmlns="http://www.w3.org/2000/svg" className="min-w-[24px]" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <Button className="flex jsutify-center items-center w-[24px] min-w-0 h-[24px] rounded-[20px] cursor-pointer" onClick={toggleColorMode}>
              {mode === 'dark' ? <svg className="min-w-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
